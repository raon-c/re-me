...
export function EditorSidebar({
  ...
  const [activeTab, setActiveTab] = useState<'info' | 'style' | 'images'>(
    'info'
  );
      ...
      <div className="p-4">
        ...
        {activeTab === 'info' && (
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onWeddingInfoUpdate({ venue: e.target.value })
                    }
                    placeholder="예식장 이름"
                    className="h-8"
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onWeddingInfoUpdate({ contact: e.target.value })
                    }
                    placeholder="연락처"
                    className="h-8"
                  />
            ...
            {/* RSVP Settings */}
            <RsvpSettings
              rsvpEnabled={weddingInfo.rsvpEnabled ?? true}
              rsvpDeadline={weddingInfo.rsvpDeadline ?? ''}
              weddingDate={weddingInfo.weddingDate}
              onRsvpEnabledChange={(enabled) =>
                onWeddingInfoUpdate({ rsvpEnabled: enabled })
              }
              onRsvpDeadlineChange={(deadline) =>
                onWeddingInfoUpdate({ rsvpDeadline: deadline })
              }
            />
          </div>
        )}
        ...
        {activeTab === 'images' && (
          <div className="space-y-4">
            ...
            {/* 이미지 갤러리 */}
            <ImageGallery onImageSelect={handleImageSelect} selectable={true} />
          </div>
        )}
      </div>
    </div>
