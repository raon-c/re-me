...
- [ ] 6. 청첩장 편집 기능 구현
  - [ ] 6.1 청첩장 편집기 컴포넌트 구현
    - 드래그 앤 드롭 기반 텍스트 편집 인터페이스 구현
    - 원터치 색상/폰트 변경 기능 구현
    - 실시간 미리보기 업데이트 기능 구현
    - 편집 상태 관리 및 자동 저장 기능 구현
    - _요구사항: 요구사항 1.2, 1.3_

  - [ ] 6.2 Supabase Storage 이미지 업로드 기능 구현
    - Supabase Storage 버킷 설정 및 정책 구성
    - 이미지 업로드 tRPC 프로시저 구현
    - 이미지 크기 조정 및 최적화 로직 구현 (Sharp 사용)
    - 프론트엔드 이미지 업로드 컴포넌트 및 미리보기 기능 구현
    - _요구사항: 요구사항 1.4_

- [ ] 7. 결혼식 정보 입력 기능 구현
  - [ ] 7.1 결혼식 정보 폼 컴포넌트 구현
